    ...
    public static void Initialize(DefaultContext context)
    {
        ...
        var products = new Product[]
        {
            ...
            new()
            {
                ...
                Currency = "USD", ProductPrice = 799.99m
            },
            new()
            {
            ...
            new()
            {
                ...
                Currency = "USD", ProductPrice = 49.99m
            },
            new()
            {
                ...
                Currency = "EUR", ProductPrice = 129.99m
            },
            new()
            {
            ...
            new()
            {
                ...
                Currency = "USD", ProductPrice = 69.95m
            }
        };
